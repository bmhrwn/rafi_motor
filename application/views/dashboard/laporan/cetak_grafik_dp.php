...
<body>
    <div class="container mt-5">
        ...
        <h3 class="mt-3 mb-4">Laporan Grafik DP Bulan <?= $text_date ?> </h3>
        ...
        <div align="center">
        <center>
            <div class="chart-bar mt-4 mr-5" style="margin-right:900px;">
                <canvas style="height: 400px;" id="myPieChart"></canvas>
            </div>
        </center>
        </div>
    </div>
